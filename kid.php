...
<main class="collection-container">
    <div class="collection-sottocontainer">
        <section class="collection">
            ...
            <div class="miniature">
                        <a data-fancybox="kid" href="./img/kid.jpeg" data-caption="Lorem ipsum dolor">
                            <img src="./img/kid.jpeg">
                        </a>
                        <a data-fancybox="kid" href="./img/kid-1.jpeg" data-caption="Lorem ipsum dolor">
                            <img src="./img/kid-1.jpeg">
                        </a>
                        <a data-fancybox="kid" href="./img/kid-2.jpeg" data-caption="Lorem ipsum dolor">
                            <img src="./img/kid-2.jpeg">
                        </a>
                        <a data-fancybox="kid" href="./img/kid-3.jpeg" data-caption="Lorem ipsum dolor">
                            <img src="./img/kid-3.jpeg">
                        </a>
                        <a data-fancybox="kid" href="./img/kid-4.jpeg" data-caption="Lorem ipsum dolor">
                            <img src="./img/kid-4.jpeg">
                        </a>
                        <a data-fancybox="kid" href="./img/kid-5.jpeg" data-caption="Lorem ipsum dolor">
                            <img src="./img/kid-5.jpeg">
                        </a>
            </div>
        </section>
        <section class="preview">
            <div class="swiper swiper-box">
                ...
                <!-- Slides -->
                <div class="swiper-slide" id="slide18"></div>
                <div class="swiper-slide" id="slide19"></div>
                <div class="swiper-slide" id="slide20"></div>
                <div class="swiper-slide" id="slide21"></div>
                <div class="swiper-slide" id="slide22"></div>
                <div class="swiper-slide" id="slide23"></div>
